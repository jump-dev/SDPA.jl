...
function test_example_2()
    ...
    # https://pdfs.semanticscholar.org/0332/d0044b09e1212e181bc422f390de05df0c88.pdf
    # Section 6.3 for the values
    ...
    @test isapprox(
        SDPA.block(X, 1),
        [6.392e-08 -9.638e-09; -9.638e-09 4.539e-08];
        rtol = 1e-4,
    )
    @test isapprox(
        SDPA.block(X, 2),
        [7.119 5.025 1.916; 5.025 4.415 2.506; 1.916 2.506 2.048];
        rtol = 1e-4,
    )
    @test isapprox(
        SDPA.block(X, 3),
    ...
    @test isapprox(
        SDPA.block(Y, 1),
        [2.640e+00 5.606e-01; 5.606e-01 3.718e+00];
        rtol = 1e-4,
    )
    @test isapprox(Y[6, 6], +4.087e-07, rtol = 1e-4)
    @test isapprox(
        SDPA.block(Y, 2),
        [0.7616 -1.514 1.139; -1.514 3.008 -2.264; 1.139 -2.264 1.705];
        rtol = 1e-3,
    )
